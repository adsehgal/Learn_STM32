...
/**
 * @desc: Writes the specified number of sectors at the given start sector
 * @param: buff: buffer containing the data to write
 * @param: sectorAddr: address of start sector
 * @param: numSectors: number of sector to write
 * @param: void
 */
...
/**
 * @desc: Reads a single sector
 * @param: buff: buffer to contain the read data
 * @param: addr: sector to read from
 * @param: void
 */
